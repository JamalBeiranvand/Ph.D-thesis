...
NRF_Vec = 6:11;                      % Number of RF chains
...
for n=1:length(NRF_Vec)
    ...
    for reali=1:realization
       ...
       [WRF_OPM,WBB_OPM,FRF_OMP,FBB_OMP] = OMP_Alg(H,At,Ar,NRF,Ns,SNR);
        ...
        R_PE(n,reali)  = log2(det(eye(Ns) + SNR/Ns * pinv(WRF_PE * WBB_PE)  * H * FRF_PE * FBB_PE * (FBB_PE)' * FRF_PE' * H' * WRF_PE * WBB_PE));
