...
Rxz = 3;                       % Number of the receiver antennas on z axis
Rxy = 3;                       % Number of the receiver antennas on y axis
...
TxSector=[60 360];
RxSector=[20 360];
SNR_dB = -10:2:0;             % Signal to noise ratio in dB
...
% Legend2='Fully Digital J Precoder';
