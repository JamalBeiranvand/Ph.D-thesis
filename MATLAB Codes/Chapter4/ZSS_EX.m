...
%hold on
polarplot(angle(Set),abs(Set),'o','Markersize',6,'MarkerEdgeColor',[0 0 0])
hold on
...
ax.Position = [ax.TightInset(1)+ax.TightInset(3)+.1 ax.TightInset(2)+.2 4.5 3.5];
Fig.Units='centimeters';
Fig.Position = [10 4 (ax.TightInset(1)+ 2*ax.TightInset(3)+ ax.Position(3)) (ax.TightInset(2)+ ax.TightInset(4)+ ax.Position(4))+1.2];
