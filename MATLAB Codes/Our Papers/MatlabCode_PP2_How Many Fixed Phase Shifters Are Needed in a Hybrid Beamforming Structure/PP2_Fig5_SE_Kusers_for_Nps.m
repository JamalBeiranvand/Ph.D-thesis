...
Legend2=['Implemented by $N_{}=$',num2str(NPS(1))];
Legend3=['Implemented by $N_{}=$',num2str(NPS(2))];
Legend4=['Implemented by $N_{}=$',num2str(NPS(3))];
Legend5=['Implemented by $N_{}=$',num2str(NPS(4))];
...
X_points=[ .5*(diff(ax.XLim)) .95*(diff(ax.XLim))]+ax.XLim(1);
Y_points=[ .15*(diff(ax.YLim)) .37*(diff(ax.YLim))]+ax.YLim(1);
